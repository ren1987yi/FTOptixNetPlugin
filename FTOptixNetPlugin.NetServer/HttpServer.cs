...
namespace FTOptixNetPlugin.NetServer
{
    /// <summary>
    ...
    public class HttpServer : TcpServer
    {
        ...
        public void AddStaticContent(string path, string prefix = "/", string filter = "*.*", TimeSpan? timeout = null,Dictionary<string,string> header_ext = null)
        {
            timeout ??= TimeSpan.FromHours(1);
